...
<!-- header logo: style can be found in header.less -->
        <header class="header">
            <a href="admin/articles" class="logo">
...
<!--                     <form action="#" method="get" class="sidebar-form">
        ...
        -->
                    ...
                    <ul class="sidebar-menu">
                        <li class="">
                            <a href="/">
                                <i class="fa fa-th"></i> <span>На сайт</span>
                            </a>
                        </li>
                        <li class="articles">
                            <a href="/admin/photos">
                                <i class="fa fa-th"></i> <span>Фотографии</span>
                            </a>
                        </li>
                        <li class="categories">
                        ...
                        <li class="articles">
                            <a href="/admin/events">
                                <i class="fa fa-th"></i> <span>Мероприятия</span>
                            </a>
                        </li>
                        <li class="articles">
                            <a href="/admin/request">
                                <i class="fa fa-th"></i> <span>Заявки</span>
                            </a>
                        </li>
                        <li class="articles">
                            <a href="/admin/tours">
                                <i class="fa fa-th"></i> <span>Экскурсии</span>
                            </a>
                        </li>
                    </ul>
                </section>
...
<script src="js/app1.js?v=2" type="text/javascript"></script>
